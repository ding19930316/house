...
$urls['php']['list'][6] = array('example'=>'('.$L['url_rewrite'].')list-g1.html','index'=>'list{$lst}-g{$page}.html', 'page'=>'list{$lst}-g{$page}.html');
...
$urls['php']['item'][4] = array('example'=>'('.$L['url_rewrite'].') 1/','index'=>'{$itemid}/', 'page'=>'{$itemid}/{$page}/');
$urls['php']['item'][5] = array('example'=>'('.$L['url_php'].') p([0-9]+)-h([0-9]+).html','index'=>'p{$itemid}-h{$houseid}.html', 'page'=>'p{$itemid}-h{$houseid}.html');
$urls['php']['item'][6] = array('example'=>'('.$L['url_php'].') tupian.php?houseid=1&itemid=1','index'=>'../newhouse/tupian.php?houseid={$houseid}&p={$itemid}', 'page'=>'tupian.php?houseid={$houseid}&p={$itemid}');
?>