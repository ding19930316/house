...
<title>二手房地图找房-<?php if($seo_title) { ?><?php echo $seo_title;?><?php } else { ?><?php if($head_title) { ?><?php echo $head_title;?><?php echo $AJ['seo_delimiter'];?><?php } ?>
...
var Plates=[];
Plates[1]=[];
var Prices=['30万以下','30-50万','50-80万','80-100万','100-120万','120-150万','200万以上'];
...
<script type="text/javascript" src="<?php echo AJ_SKIN;?>js/map/mapApi.js"></script>
<script type="text/javascript" src="<?php echo AJ_SKIN;?>js/map/mapObj.js"></script>
...
<div id="mapheader">
  ...
  <div class="fl"><a href="/"><img src="<?php if($MODULE[$moduleid]['logo']) { ?><?php echo AJ_SKIN;?>image/logo_<?php echo $moduleid;?>.gif<?php } else if($AJ['logo']) { ?><?php echo $AJ['logo'];?><?php } else { ?><?php echo AJ_SKIN;?>image/logo.gif<?php } ?>
" width="260" height="60"></a></div>
  ...
  <div class="mapss">
    <div class="mapss_nav"><a href="<?php echo $MODULE['1']['linkurl'];?>map" class="on">二手房地图</a> | <a href="<?php echo $MODULE['1']['linkurl'];?>map/rent.php">租房地图</a> | <a href="<?php echo $MODULE['1']['linkurl'];?>map/newhouse.php">新房地图</a></div>
    <div class="mapss_cont">
    <form action="<?php echo $MODULE['5']['linkurl'];?>search.php"   method="get">
...
<div id="mapnoti">
  ...
  <div class="oviews"><a href="<?php echo $MODULE['5']['linkurl'];?>list.php" target="_blank" hidefocus>列表视图</a><a href="javascript:;" id="tab_m_views" class="m_fullp" hidefocus>全屏地图</a></div>
