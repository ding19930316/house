<?php defined('IN_AIJIACMS') or exit('Access Denied');?><table cellpadding="0" cellspacing="0" width="700" align="center" style="font-family:Verdana,Arial;">
<tr>
...
您好！<br/>
欢迎您加入<?php echo $AJ['sitename'];?>，您的会员帐号为：<br/>
...
<br/>
本站网址：<a href="<?php echo AJ_PATH;?>" target="_blank"><?php echo AJ_PATH;?></a><br/>
</td>
</tr>
<tr>
<td style="background:#333333;padding:10px;line-height:180%;font-size:12px;color:#FFFFFF;">请注意：此邮件系 <a href="<?php echo AJ_PATH;?>" target="_blank" style="color:#FFFFFF;"><?php echo $AJ['sitename'];?></a> 自动发送，请勿直接回复。<br/>如果此邮件不是您请求的，请忽略并删除！</td>
</tr>
</table>