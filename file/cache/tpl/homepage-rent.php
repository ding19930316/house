...
<td><strong style="font-size: 18px; color: #CC0000"><?php if($price) { ?><?php echo $price;?>元/月<?php } else { ?>面议<?php } ?>
</td>
</tr>
...
document.write('<br/><br/><center><a href="<?php echo $MODULE['4']['linkurl'];?>home.php?action=prevrent&itemid=<?php echo $itemid;?>&username=<?php echo $username;?>" class="t">&#171;上一个房源</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $MODULE['4']['linkurl'];?>home.php?action=nextrent&itemid=<?php echo $itemid;?>&username=<?php echo $username;?>" class="t">下一个房源&#187;</a></center>');
</script>
</td>
</tr>
</table>
...
<?php if($i%3==0) { ?><tr><?php } ?>
<td width="33%" id="type_<?php echo $t['typeid'];?>"><a href="<?php echo userurl($username, 'file=rent&typeid='.$t['typeid'], $domain);?>" title="<?php echo $t['typename'];?>" id="name_<?php echo $t['typeid'];?>"><?php echo set_style($t['typename'], $t['style']);?></a></td>
<?php if($i%3==2) { ?></tr><?php } ?>
<?php } } ?>
</table>
</div>
...
<?php if($view) { ?>
<a href="<?php echo userurl($username, 'file=rent&typeid='.$typeid, $domain);?>">以橱窗方式浏览</a> | <strong>以目录方式浏览</strong>
<?php } else { ?>
<strong>以橱窗方式浏览</strong> | <a href="<?php echo userurl($username, 'file=rent&view=1&typeid='.$typeid, $domain);?>">以目录方式浏览</a>
<?php } ?>
</span>
