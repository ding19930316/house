...
<a <?php if(empty($range)) { ?>class="c"<?php } ?>
 href="<?php echo $MOD['linkurl'];?>list<?php echo deal_str($lst,'p');?>.html">全部</a>
...
<h2>
<span class="hl_page">
共为您找到 <b class="red"><?php echo $items;?></b> 个房源<a class="pre" href="<?php echo $MOD['linkurl'];?>list<?php echo deal_str($lst,'g');?>-g<?php if($page==1) { ?>1<?php } else { ?><?php echo $page-1;?><?php } ?>
...
<a <?php if(empty($hot)) { ?> class="on"<?php } ?>
 ...
 href="list<?php echo deal_str($lst,'u');?>-h1.html" >热推房源</a>
...
<div class="lista"><?php echo ad($moduleid,$catid,$kw,7);?></div><div class="lista">
