...
<div id="main">
<div class="bread">您当前的位置：：<a href="<?php echo $MODULE['1']['linkurl'];?>" title="<?php echo $AJ['sitename'];?>"><?php echo $AJ['sitename'];?></a> &gt;<a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a></div>
...
<h2>
<span class="hl_page">
共为您找到 <b class="red"><?php echo $items;?></b> 条信息
