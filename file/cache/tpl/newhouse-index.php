...
<?php echo tag("moduleid=$moduleid&condition=status=3 and isnew=1$dtype&areaid=$cityid&pagesize=".$MOD['pagesize']."&page=$page&showpage=1&datetype=5&order=".$MOD['order']."&fields=".$MOD['fields']."&lazy=$lazy&template=list-newhouse");?>
</div>
...
>
    ...
    <div class="shengming"> <?php echo $AJ['sitename'];?>所提供的2018 <?php if($AJ['city']) { ?><?php echo $city_name;?><?php } else { ?><?php echo $AJ['city_sitename'];?><?php } ?>
