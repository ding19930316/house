...
<ul id="dtl_pul">
     ...
     <?php $tags=tag("table=house_pic&condition=item=$itemid&pagesize=8&order=itemid desc&template=null");?>
...
<table>
<tr>
<td colspan="2">售价：<span class="red"><?php if($price) { ?><b><?php echo $price;?></b>万</span>(<?php echo $danjia;?>元/平米)<?php } else { ?><b>面议</b></span>   <?php } ?>
                              <a href="<?php echo $MODULE['1']['linkurl'];?>tool" target="_blank" class="dtl_jsq">贷款计算器</a>
                                                                </td>
</tr>
<tr>
...
<tr>
<td>朝向：<?php echo getbox_diaoval('toward','checkbox',$toward,'sale_5');?></td>
<td>楼层：第<?php echo $floor1;?>层/总<?php echo $floor2;?>层</td>
</tr>
<tr>
<td>类型：<?php echo cat_pos($CAT, ' &raquo; ');?></td>
<td>装修：<?php echo getbox_diaoval('fix','checkbox',$fix,'sale_5');?></td>
</tr>
<tr>
...
<tr>
<td colspan="2">房源特色：<font title="<?php echo $address;?>"><?php echo $fyts;?></font></td>
</tr>
</table>
...
<?php if($hall) { ?><?php echo $hall;?>厅<?php } ?>
<?php if($toilet) { ?><?php echo $toilet;?>卫<?php } ?>
,<?php echo $price;?>万元" data-val="<?php echo $itemid;?>" data-url="<?php echo $linkurl;?>" class="obtn" href="javascript:void(0)" id="alm1">预约看房</a><?php } ?>
                            </div>
<div class="dtl_ca">
...
<?php if($thumb) { ?>
  ...
  <?php $tags=tag("table=house_pic&condition=item=$itemid&mid=5&pagesize=8&order=itemid desc&template=null");?>
 <?php if(is_array($tags)) { foreach($tags as $i => $t) { ?>    
...
<?php echo $t['houseearm'];?>平米<br>
                                <span class="red"><?php if($t['price']) { ?><?php echo $t['price'];?>万元<?php } else { ?>面议<?php } ?>
</span>
                            </li><?php } } ?>
                                            </ul>
                </div>
...
<?php if($hall) { ?><?php echo $hall;?>厅<?php } ?>
<?php if($toilet) { ?><?php echo $toilet;?>卫<?php } ?>
,<?php echo $danjia;?>元/平米,<?php echo $houseearm;?>平米,<?php echo $toward;?>,电话：<?php echo $telephone;?>",
hid:"<?php echo $itemid;?>",
