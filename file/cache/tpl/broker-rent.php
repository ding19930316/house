...
<input type="hidden" name="file" value="rent"/>
            <select name="catid">
...
<?php $jiage = array('200元以下', '200-500元', '500-1000元', '1000-1500元', '1500-2000元', '2000-3000元','3000元以上');?>
  ...
  <?php if(is_array($lists)) { foreach($lists as $i => $t) { ?>
    <div class="b_elist_lloupan">
             <div class="b_elist_lloupanimg fl"><a href="<?php echo $t['linkurl'];?>" target="_blank"><img src="<?php echo imgurl($t['thumb']);?>" width="100" height="75"></div>
                ...
                <ul>
                      <li class="title"><a href="<?php echo $t['linkurl'];?>" class="title" target="_blank" title="<?php echo $t['alt'];?>"><?php echo dsubstr($t['alt'], 42, $suffix = '');?></a></li>
