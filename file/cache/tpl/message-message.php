...
.msg{width:400px;background:#FFFFFF url('<?php echo AJ_SKIN;?>image/messagebg.gif') repeat-x;margin:auto;}
.head{letter-spacing:2px;line-height:29px;height:26px;overflow:hidden;font-weight:bold;}
.content{padding:10px 20px 5px 20px;line-height:200%;word-break:break-all;border:#3399cc 1px solid;border-top:none;}
.ml{color:#FFFFFF;background:url('<?php echo AJ_SKIN;?>image/message.gif') no-repeat 0 0;padding-left:10px;}
.mr{float:right;background:url('<?php echo AJ_SKIN;?>image/message.gif') no-repeat 0 -34px;width:4px;font-size:1px;}
</style>
<script type="text/javascript">try {document.execCommand("BackgroundImageCache", false, true);} catch(e) {}</script>
</head>
<?php if($dtime == -1) { ?>
<body style="background:#FFFFFF;margin:10px;color:#444444;">
<img src="<?php echo AJ_SKIN;?>image/load.gif" align="absmiddle"/> Loading...
<?php echo $dmessage;?>
