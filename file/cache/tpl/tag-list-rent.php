...
<i>|</i><?php echo $t['houseearm'];?>平米<i>|</i><i>|</i><?php echo $t['floor1'];?>/<?php echo $t['floor2'];?>层<i>|</i><?php echo getbox_diaoval('zhuanxiu','checkbox',$t['zhuanxiu'],'rent_7');?><i>|</i>朝向<?php echo getbox_diaoval('toward','checkbox',$t['toward'],'rent_7');?><i>|</i>房龄<?php echo $t['houseyear'];?>年                                </p>
                                ...
                                <span class="price"><b><?php if($t['price']) { ?><?php echo $t['price'];?></b>元/月<?php } else { ?>面议</b><?php } ?>
</span>
