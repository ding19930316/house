...
function deditor($moduleid = 1, $textareaid = 'content', $toolbarset = 'Default', $width = 500, $height = 400) {
	...
	$editor .= '<script charset="utf-8" type="text/javascript" src="'.$moddir.'kindeditor/kindeditor-min.js"></script>';
	$editor .= '<script charset="utf-8" type="text/javascript" src="'.$moddir.'kindeditor/lang/zh_CN.js"></script>';
	...
	if($toolbarset=='Default') {
		
  }
  else if($toolbarset=='Basic'){
    $toolbutton = "['plainpaste','clearhtml','quickformat','|','fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist', 'insertunorderedlist', '|', 'emoticons', 'image', 'link']";
    $editor .= 'items : '.$toolbutton.','; 
  }
  else if($toolbarset=='Aijiacms'){
    $toolbutton = "[]";
    $editor .= 'items : '.$toolbutton.','; 
  }
  else if($toolbarset=='Simple'){
    $toolbutton = "['plainpaste','clearhtml','quickformat','|','fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline']";
    $editor .= 'items : '.$toolbutton.','; 
  }
	$editor .= 'cssPath : "'.$moddir.'kindeditor/config.css"';  
    $editor .= '});';
	$editor .= '});';
	$editor .= '</script>'; 
...
if($submit) {
	...
	if(isset($post['thumb3']) && !is_url($post['thumb3'])) $post['thumb3'] = '';
	if(isset($post['thumb4']) && !is_url($post['thumb4'])) $post['thumb4'] = '';
}
/*
		读取新房分类
	*/
