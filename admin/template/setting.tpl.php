...
<td><input name="setting[waplogo]" type="text" value="<?php echo $waplogo;?>" id="waplogo" size="58"/> <span onclick="Dthumb(1,68,40, Dd('waplogo').value, 0, 'waplogo');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="if(Dd('waplogo').value){Dd('showwaplogo').src=Dd('waplogo').value;}" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('waplogo').value='';Dd('showwaplogo').src='<?php echo AJ_SKIN;?>image/waplogo.png';" class="jt">[删除]</span><br/>
<a href="<?php echo AJ_PATH;?>" target="_blank"><img src="<?php echo $waplogo ? $waplogo : AJ_SKIN.'image/waplogo.png';?>" style="margin:2px;" id="showwaplogo"/></a></td>
</tr>
<tr>
<td class="tl">版权信息</td>
...
<div class="tt">微信设置</div>
<table cellpadding="2" cellspacing="1" class="tb">


<tr>
<td class="tl">微信TOKEN</td>
<td><input type="text" name="setting[weixin_token]" value="<?php echo $weixin_token;?>" size="30"/> 这个值要和微信互动平台里所填一致</td>
</tr>

<tr>
<td class="tl">微信关注自动回复</td>
<td><textarea name="setting[weixin_reply]" id="copyright" style="width:270px;height:90px;"><?php echo $weixin_reply;?></textarea><br/>当有用户关注您的微信后，会自动发送该。
...
<tr>
<td class="tl">微信接口地址</td>
<td><?php echo $MODULE['1']['linkurl'].'api/weixin.php';?>把这个地址复制粘贴到微信互动平台接口地址处</td>
</tr>
</table>
</div>
<script type="text/javascript">
