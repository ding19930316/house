...
$().ready(function() {
	$("#company").autocomplete("<?php echo AJ_PATH;?>member/ajaxb.php?action=getBoroughList", {
		minChars: 2,
		width: 260,
		delay:0,
		mustMatch:true,
...
<td width="300">
			<input type="hidden" id="userid" name="member[companyid]" value="<?php echo $vcompanyid;?>" >
			<input type="text" class="reg_inp" style="width:280px;" name="member[company]" id="company" value="<?php echo $company;?>" onblur="validator('company');"/>&nbsp;<a href="#vv"><img src="<?php echo $MOD['linkurl'];?>image/<?php echo $vcompany ? 'v' : 'u';?>_company.gif" width="16" height="16" title="<?php echo $vcompany ? '已通过' : '未通过';?>工商认证" align="absmiddle"/></a></td>
</tr>
