...
设置内容第 <input name="post[thumb_no]" type="text" size="2" value="<?php echo $MOD['thumb_no']?>"/> 张图片为标题图
</td>
</tr>
...
<td><input name="post[hits]" type="text" size="10" value="<?php if($hits) { ?><?php  echo $hits;?><?php } else { ?><?php echo $MOD['hits']?><?php } ?>"</td>
</tr>
<tr>
