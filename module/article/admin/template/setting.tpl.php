...
<tr>
<td class="tl">设置第几张图片为标题图</td>
<td><input type="text" size="3" name="setting[thumb_no]" value="<?php echo $thumb_no;?>"/>张</td>
</tr>
<tr>
<td class="tl">默认点击次数</td>
<td><input type="text" size="3" name="setting[hits]" value="<?php echo $hits;?>"/> 次</td>
</tr>
<tr>
